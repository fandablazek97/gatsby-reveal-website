...
export default function LogosEight({title, subtitle, logo1, logo2, logo3, logo4, logo5, logo6, logo7, logo8}) {
        ...
        <section className="logos bg-white">
            ...
            <motion.div ref={element} variants={fadeFast} animate={controls} initial="hidden" className="grid py-6 wrap">
                ...
                <div className="cell l-6 logos__container logos__container--eight">
                    ...
                    <motion.div variants={fadeItem} className="logos__logo-placeholder"><img src={logo7} alt="logo"></img></motion.div>
                    <motion.div variants={fadeItem} className="logos__logo-placeholder"><img src={logo8} alt="logo"></img></motion.div>
                </div>
