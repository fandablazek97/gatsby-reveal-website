    ...
    return (
        <section className="cover cover--fullscreen">
            <motion.div ref={element} variants={fadeFast} animate={controls} initial="hidden" className="intro wrap">
                ...
                <motion.a variants={opacityItem} className="btn-inverse-primary btn-icon-left" href="tel:+420737090913"><span class="material-icons-outlined">phone_iphone</span>+420 737 090 913</motion.a>
                <motion.a variants={opacityItem} className="btn-inverse-primary btn-icon-left" href="mailto:info@revealmedia.cz"><span class="material-icons-outlined">email</span>info@reveal.cz</motion.a>
                </div>
